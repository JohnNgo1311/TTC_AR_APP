...
public class GetJBTSDImages : MonoBehaviour
{
    ...
    public async void GetJBTSDAllImages()
    {
        try
        {
            ...
            //     return;
            // }
            var temp_JB = StaticVariable.temp_ListJBInformationModel.Find(jb => jb.Name == StaticVariable.jb_TSD_Name);
            ...
            await APIManagerOpenCV.Instance.GetJBInformation(StaticVariable.GetJBUrl + "/" + temp_JB.Id);
