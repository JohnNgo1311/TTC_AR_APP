...
public class Get_All_Data_By_Grapper_For_Searching : MonoBehaviour
{
    ...
    public async void GetAllDataByGrapperForSearching()
    {
        ...
        APIManager.Instance.GetAllDevicesByGrapper(url: $"{GlobalVariable.baseUrl}Device_GrapperA", grapperId: ""),
        APIManager.Instance.GetAllJBsByGrapper(url: $"{GlobalVariable.baseUrl}JB_TSD_Information_GrapperA", grapperId: "")
        );
