...
public class Update_JB_TSD_Detail_UI : MonoBehaviour
{
    ...
    private async void RunApplyFunctions()
    {
        ...
        {
            LoadImage.Instance.LoadImageFromUrlAsync(StaticVariable.temp_JBInformationModel.OutdoorImage.Name, jb_location_imagePrefab)
        };
        ...
        foreach (var image in StaticVariable.temp_JBInformationModel.ListConnectionImages)
        {
            ...
            tasks.Add(LoadImage.Instance.LoadImageFromUrlAsync(image.Name, new_jb_connection_image));
        }
