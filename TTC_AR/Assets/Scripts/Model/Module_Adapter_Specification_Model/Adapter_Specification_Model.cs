...
#nullable enable
  ...
  public string? Input_Supply { get; set; }
  ...
  public Adapter_Specification_Model(string? code, string? type, string? communication, string? num_Of_Module_Allowed, string? comm_Speed, string? input_Supply, string? output_Supply, string? inrush_Current, string? alarm, string? noted, string? pdf_Turtorial)
  {
    Code = code;
    Type = type;
