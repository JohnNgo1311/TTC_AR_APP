...
public class UpdateAdapterSpecificationSettingView : MonoBehaviour, IAdapterSpecificationView
{
    ...
    private void OpenSuccessUpdateDialog(AdapterSpecificationModel model)
    {
        ...
        var dialog_Content = DialogOneButton.transform.Find("Background/Dialog_Content").GetComponent<TMP_Text>().text = $"Bạn đã thành công cập nhật loại Adapter <color=#FF0000><b>{model.Code}</b></color>"; ;
