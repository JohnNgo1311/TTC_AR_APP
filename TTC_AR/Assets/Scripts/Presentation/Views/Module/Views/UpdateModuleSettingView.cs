...
//         AddButtonListeners(initialize_Module_List_Option_Selection.Module_List_Selection_Option_Content_Transform, "Modules");
//         AddButtonListeners(initialize_Module_List_Option_Selection.Location_Image_List_Selection_Option_Content_Transform, "Location_Image");
//         AddButtonListeners(initialize_Module_List_Option_Selection.Connection_Image_List_Selection_Option_Content_Transform, "Connection_Images");
...
//         {
//             OpenErrorDialog(title: "Cập nhật tủ Module thất bại", message: "Vui lòng nhập mã tủ Module");
//             return;
//         }
//         else
//         {
...
//                 break;
//             case "Modules":
//                 initialize_Module_List_Option_Selection.selection_List_ModuleIO_Panel.SetActive(false);
//                 break;
//             case "Location_Image":
//                 initialize_Module_List_Option_Selection.selection_List_Location_Image_Panel.SetActive(false);
//                 break;
//             case "Connection_Images":
//                 initialize_Module_List_Option_Selection.selection_List_Connection_Image_Panel.SetActive(false);
//                 break;
//         }
...
//             "Modules" => initialize_Module_List_Option_Selection.selection_List_ModuleIO_Panel,
//             "Location_Image" => initialize_Module_List_Option_Selection.selection_List_Location_Image_Panel,
//             "Connection_Images" => initialize_Module_List_Option_Selection.selection_List_Connection_Image_Panel,
//             _ => throw new ArgumentException("Invalid field Name")
//         };
//     }

//     private void OpenErrorDialog(string title = "Cập nhật tủ Module thất bại", string message = "Đã có lỗi xảy ra khi Cập nhật tủ Module. Vui lòng thử lại sau.")
//     {
...
//     private void OpenSuccessDialog(string title = "Cập nhật tủ Module thành công", string message = "Bạn đã cập nhật tủ Module thành công: ")
//     {
//         DialogOneButton.SetActive(true);
...
//         DialogOneButton.transform.Find("Background/Dialog_Content").GetComponent<TMP_Text>().text = message + $"<color=#004C8A>{ModuleInformationModel.Name}";
...
//         if (GlobalVariable.APIRequestType.Contains("PUT_Module"))
//         {
//             Show_Toast.Instance.ShowToast("success", "Cập nhật tủ Module thành công");
//             OpenSuccessDialog();
//         }
//         if (GlobalVariable.APIRequestType.Contains("GET_Module"))
//         {
