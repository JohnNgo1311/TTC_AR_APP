...
//         {
//             OpenErrorDialog("Vui lòng nhập mã tủ Module");
//             return;
//         }
//         else
//         {
...
//     private void OpenErrorDialog(string title = "Tạo tủ Module mới thất bại", string message = "Đã có lỗi xảy ra khi tạo tủ Module mới. Vui lòng thử lại sau.")
//     {
...
//         backgroundTransform.Find("Dialog_Content").GetComponent<TMP_Text>().text = $"Bạn đã thành công thêm tủ Module <color=#004C8A><b>{model.Name}</b></color> vào hệ thống";
//         backgroundTransform.Find("Dialog_Title").GetComponent<TMP_Text>().text = "Thêm tủ Module mới thành công";
...
//         if (GlobalVariable.APIRequestType.Contains("POST_Module"))
//         {
//             Show_Toast.Instance.ShowToast("success", "Thêm tủ Module mới thành công");
